...
import (
	...
	application "github.com/Educaction/go-hexagonal/application"
...
func (m *MockProductWriter) Save(arg0 application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProductWriterMockRecorder) Save(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductWriter)(nil).Save), arg0)
}
...
// Save mocks base method.
func (m *MockProductPersistenceInterface) Save(arg0 application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", arg0)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save indicates an expected call of Save.
func (mr *MockProductPersistenceInterfaceMockRecorder) Save(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductPersistenceInterface)(nil).Save), arg0)
}
